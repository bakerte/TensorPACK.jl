...
export TENPACK
  ...
  files = ["imports.jl","banner.jl","types.jl","tensordef.jl","largevector.jl","isapprox.jl","exports.jl"]
  for w = 1:length(files)
    include(libpath*files[w])
  end

  subdir = "libalg/"
  files = ["libalg.jl","blas.jl","hessenberg.jl","libeigen.jl","libsvd.jl","libmult.jl","libqr.jl","liblq.jl","matmul.jl"]
  for w = 1:length(files)
